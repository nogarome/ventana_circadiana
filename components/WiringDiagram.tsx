      ...
      <div className="min-w-[900px] h-[750px] relative mx-auto select-none bg-white rounded-lg shadow-sm">
        ...
        <svg viewBox="0 0 1000 750" className="w-full h-full font-sans">
          ...
          <g transform="translate(320, 50)" filter="url(#shadow)">
            ...
            >
              ...
              <g transform="translate(0, 40)">
                ...
                <circle cx="5" cy="0" r="6" fill="#4ade80" />{" "}
              </g>
              <g transform="translate(0, 80)">
                ...
                <circle cx="5" cy="0" r="6" fill="#38bdf8" />{" "}
              </g>
              <g transform="translate(0, 120)">
                ...
                <circle cx="5" cy="0" r="6" fill="#fb923c" />{" "}
              </g>
              <g transform="translate(0, 160)">
                ...
                <circle cx="5" cy="0" r="6" fill="#94a3b8" />{" "}
              </g>
              ...
              <g transform="translate(0, 320)">
                ...
                <circle cx="5" cy="0" r="6" fill="#a8a29e" />{" "}
              </g>
            ...
            >
              ...
              <g transform="translate(0, 360)">
                ...
                <circle cx="-5" cy="0" r="6" fill="#a78bfa" />{" "}
              </g>
              <g transform="translate(0, 400)">
                {" "}
                <text x="-30" y="5">
          ...
          <g transform="translate(650, 200)" filter="url(#shadow)">
            ...
            >
              <g transform="translate(10, 0)">
                <rect width="25" height="14" fill="#ef4444" rx="2" />{" "}
                <text x="12.5" y="11" textAnchor="middle">
                  VCC
                </text>
              </g>
              ...
              <g transform="translate(70, 0)">
                <rect width="25" height="14" fill="#d946ef" rx="2" />{" "}
                <text x="12.5" y="11" textAnchor="middle">
                  TXD
                </text>
              </g>
              <g transform="translate(100, 0)">
                <rect width="25" height="14" fill="#06b6d4" rx="2" />{" "}
                <text x="12.5" y="11" textAnchor="middle">
                  RXD
                </text>
              </g>
          ...
          <g fill="none" strokeWidth="3" strokeLinecap="round">
            {/* 1. VCC (5V) */}
            <path
              d="M575,200 L620,200 L620,335 L660,335"
              stroke="#ef4444"
              strokeDasharray="4,4"
              opacity="0.6"
            />
            ...
            {/* 2. GND */}
            <path
              d="M575,120 L630,120 L630,335 L690,335"
              stroke="#0f172a"
              strokeDasharray="4,4"
              opacity="0.6"
            />
            ...
            <path
              d="M732,330 L732,360 L600,360 L600,50 L280,50 L280,110 L325,110"
              stroke="#d946ef"
              strokeWidth="4"
            ...
            <path
              d="M575,320 L610,320 L610,380 L762,380 L762,344"
              stroke="#06b6d4"
              strokeWidth="4"
          ...
          <g transform="translate(320, 670)">
            ...
            <path
              d="M345,200 L280,200 L280,660 L370,660"
              stroke="#fb923c"
              strokeWidth="2"
              strokeDasharray="4,4"
              fill="none"
            />
            <path
              d="M345,160 L260,160 L260,690 L480,690 L480,660"
              stroke="#38bdf8"
              strokeWidth="2"
              strokeDasharray="4,4"
              fill="none"
          ...
          <g transform="translate(650, 50)" filter="url(#shadow)">
            ...
            <g transform="translate(20, 50)" fontSize="10" fill="white">
              ...
              <path
                d="M25,5 L-50,5 L-50,365 L-30,365"
                stroke="#a78bfa"
                strokeWidth="1"
                fill="none"
                opacity="0.5"
              ...
              <path
                d="M25,25 L-60,25 L-60,405 L-30,405"
                stroke="#a78bfa"
                strokeWidth="1"
                fill="none"
                opacity="0.5"
      ...
      <div className="mt-4 grid grid-cols-2 gap-4 max-w-[900px] mx-auto">
        <div className="bg-fuchsia-50 p-3 rounded-lg border border-fuchsia-200 flex items-center gap-3">
          ...
          <span className="text-xs font-bold text-fuchsia-800">
            CABLE MAGENTA: Módulo TXD → Nano D12
          </span>
        </div>
        <div className="bg-cyan-50 p-3 rounded-lg border border-cyan-200 flex items-center gap-3">
          ...
          <span className="text-xs font-bold text-cyan-800">
            CABLE CIAN: Módulo RXD ← Nano D13
          </span>
        </div>
      </div>
    </div>
